    ...
    override func viewDidLoad() {
        ...
        for i in 0...self.allLocationsNoSpace.count-1{
            ...
            for n in 0...self.allLocationsNoSpace.count-1{
                ...
                let url = URL(string: "https://maps.googleapis.com/maps/api/distancematrix/json?units=imperial&origins=\(self.allLocationsNoSpace[i])+&destinations=\(self.allLocationsNoSpace[n])&key=BLOCKEDAPIKEY")!
